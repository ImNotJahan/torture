...
public final class EventSubscriber
{
    ...
    public static void onRegisterItems(RegistryEvent.Register<Item> event)
    {
        event.getRegistry().registerAll(
                ...
                setup(new Item(new Item.Properties().tab(Main.GROUP).food(Foods.JUST_NUTRITION[3])), "rice_egg"),
                setup(new Item(new Item.Properties().tab(Main.GROUP).food(Foods.JUST_NUTRITION[3])), "rice_egg_sauced"),
                ...
                setup(new Item(new Item.Properties().tab(Main.GROUP).food(Foods.JUST_NUTRITION[0])), "soy_sauce"),
                setup(new Item(new Item.Properties().tab(Main.GROUP).food(Foods.JUST_NUTRITION[0])), "sesame_oil"),
                ...
                setup(new UsableItem(new Item.Properties().tab(Main.GROUP).food(Foods.JUST_NUTRITION[8]).durability(8)), "german_pizza"),
                setup(new Item(new Item.Properties().tab(Main.GROUP).food(Foods.JUST_NUTRITION[1])), "german_pizza_slice"),
                setup(new UsableItem(new Item.Properties().tab(Main.GROUP)), "pizza_cutter"),
                setup(new Item(new Item.Properties().tab(Main.GROUP).food(Foods.JUST_NUTRITION[1])), "katsudon"),
                setup(new Item(new Item.Properties().tab(Main.GROUP).food(Foods.JUST_NUTRITION[1])), "pork_cutlet"),
                setup(new Item(new Item.Properties().tab(Main.GROUP).food(Foods.JUST_NUTRITION[1])), "cream_stew"),
                setup(new Item(new Item.Properties().tab(Main.GROUP).food(Foods.JUST_NUTRITION[1])), "oyster"),
